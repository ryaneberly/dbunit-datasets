 ...
 */
public class CharReplacingFlatXmlWriter implements IDataSetConsumer
{
            ...
            throws IOException, DataSetException
    {
    	...
    	CharReplacingFlatXmlWriter datasetWriter = new CharReplacingFlatXmlWriter(writer, encoding);
     ...
     */
    private static final Logger logger = LoggerFactory.getLogger(CharReplacingFlatXmlWriter.class);
    ...
    public CharReplacingFlatXmlWriter(OutputStream out) throws IOException
    {
        this(out, null);
    }
     ...
     */
    public CharReplacingFlatXmlWriter(OutputStream outputStream, String encoding) 
    throws UnsupportedEncodingException
    {
    ...
    public CharReplacingFlatXmlWriter(Writer writer)
    {
        _xmlWriter = new XmlWriter(writer);
        _xmlWriter.enablePrettyPrint(true);
    }

    public CharReplacingFlatXmlWriter(Writer writer, String encoding)
    {
            ...
            for (int i = 0; i < columns.length; i++)
            {
                ...
                try
                {
                    ...
                    while(columnName.contains("#")){
                    	columnName = columnName.replace("#", "__POUNDSIGN");
                    }
